...
- [25 — Índice próprio de TypeScript](25-typescript-index.md) — **não iniciada**: o analisador externo custa 1,9 GB e 30 s porque guarda o programa inteiro; um índice responde busca, navegação e o `.` **declarado** em dezenas de MB — e diz que não soube no resto, em vez de mentir
