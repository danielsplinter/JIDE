...
- [21 — O que muda fora da IDE](21-file-watcher.md) — fase 1 feita: o que muda no disco chega ao índice em ~700 ms, sem ação do usuário; falta a **fase 2**, a varredura da abertura em paralelo
